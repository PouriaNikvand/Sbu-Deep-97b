...
# Input Layer   tf.placeholder(tf.float32,shape=(None,number_of_inputs))
...
with tf.variable_scope('layer_1'):
    ...
    weights =tf.get_variable(name="weight1",shape=[layer_1_nodes,number_of_inputs],initializer=tf.contrib.layers.xavier_initializer)
    # [layer_1_nodes]
    biases =tf.get_variable(name="bias1",shape=[layer_1_nodes],initializer=tf.zeros_initializer)
