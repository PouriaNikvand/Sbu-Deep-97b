...
with tf.Session() as session:
    ...
    training_writer = tf.summary.FileWriter("./logs1/{}/training".format(RUN_NAME), session.graph)
    testing_writer = tf.summary.FileWriter("./logs1/{}/testing".format(RUN_NAME), session.graph)
